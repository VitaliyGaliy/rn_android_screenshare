...
public class ScreenShareActivity extends Activity implements WebRtcClient.RtcListener{
...
//            Log.i(TAG, "checkCallingOrSelfPermission(permission) " +checkCallingOrSelfPermission(permission));
